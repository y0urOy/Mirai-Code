...
def main(args):
    ...
    if args.ema:
        if "ema" in checkpoint:
            print("Loading EMA weights for GPT model.")
            gpt_model.load_state_dict(checkpoint["ema"], strict=False)
        else:
            print("WARNING: EMA weights not found in checkpoint. Using normal weights.")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ema", action='store_true', help="whether to use EMA weights for sampling")
